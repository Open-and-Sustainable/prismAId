# <div style="text-align: center;">![logo](https://github.com/ricboer0/prismAId/blob/main/figures/prismAId_logo.png)</div>$$prism{\color{red}A}{\color{blue}I}d$$
# <div style="text-align: center;">Open Science AI Tools for Systematic, Protocol-Based Literature Reviews</div>
